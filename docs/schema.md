...
| `track_id` | string | no | Source track the segment was cut from (factory output) |
| `track_offset` | float | no | Segment start within the source track, seconds (factory output) |
